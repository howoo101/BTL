...
<div id="section2" class="mt-3">
    <div class="container center-block">
        <div class="card border-primary">
            <div class="card-body">
                <div class="text-primary font-weight-bold card-title"><h5>채용정보</h5></div>
            ...
            <div class="row" id="saraminRow1">
                ...
                <div class="col-sm-4  ">
                    ...
                    <div class="panels panel-default text-center bg-success">
                        <!-- 패널 헤드 배경색 넣는곳
                             expriationTimestamp의 span 에다가 값을 만료일을 생성해서 넣어주는듯.
                          -->
                        <div class="panel-headings bg-primary">
                        ...
                        <div class="panels-body">
                            ...
                            <h5>
                                ...
                                <a
                                        ...
                                        target="_blank"
                                ><b>[(주)신흥정밀] 제조팀 수리사 신입/경력 사원 모집</b></a
                                >
                            </h5>
                        </div>
                        ...
                        <div class="panel-footers">
                            <p>
                                <small>
                                    <span class="experienceLevel">신입/경력</span> |
                                    <span class="requiredEducationLevel">고졸↑</span> |
                                    <span class="location">경기</span> |
                                    <span class="industry">전기</span></small
                                >
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="panels panel-default text-center">
                        ...
                        <div class="panel-footers">
                            <p>
                                <small>
                                    <span class="experienceLevel">경력무관</span> |
                                    <span class="requiredEducationLevel">대졸↑</span> |
                        ...
                        <div class="panel-footers">
                            <p>
                                <small>
                                    ...
                                    <span class="requiredEducationLevel">대졸↑</span> |
                                    <span class="location">서울</span> |
                                    <span class="industry"></span></small>
                            </p>
                        </div>
                    </div>
                </div>
