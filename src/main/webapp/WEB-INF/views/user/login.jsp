...
<meta name="google-signin-client_id" content="589581046105-skr2iee57c8j3o02lsl3g284ts0g0ks9.apps.googleusercontent.com">
 ...
 <script type="text/javascript" src="https://static.nid.naver.com/js/naverLogin_implicit-1.0.3.js" charset="utf-8"></script>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge"/> <!-- 카카오 로그인 -->
  ...
  <form class="form-login"  >
 	   ...
 	   <br>
 	  	<!-- 소셜 로그인 패널 -->
 	  	<div id="sns_nav" >
			 <button> <div class="g-signin2 div-inline" data-onsuccess="onSignIn"> </div> </button> 
			<button>  <a id="custom-login-btn" href="javascript:loginWithKakao()"><img src="resources/img/kakao_login_btn_medium.png" height="42px"></a></button> 
			<button><div id="naver_id_login"></div> </button>
		</div>
 
 	  <input id="naver_email" type="hidden" value="" >  <!-- 네이버 이메일 콜백리턴 -->
	  <input id="naver_name" type="hidden" value="">  <!-- 네이버 닉네임  콜백리턴 -->
