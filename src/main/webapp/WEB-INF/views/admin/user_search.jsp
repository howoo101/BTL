...
/* $('#user_search').click(function(){
		$("#admin_body").load("${pageContext.request.contextPath}/user_search",{"user_name":$(user_name_search).val()});
}); */
</script>	
	...
	onclick="window.open(this.href,'유저 관리','width=800, height=500'); return false;">클릭</a></td>
	<td>${ul.user_id}</td>
