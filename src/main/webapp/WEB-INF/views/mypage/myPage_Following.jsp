							...
							<div class="row">
								<div class="col-lg-6 ml-5">
									<div class="row justify-content-center">
										<h4>
											<a
												href="${path }/info?ci_companyName=${item.ci_companyName}&ci_id=${item.ci_id}">
								...
								<div class="col-lg-auto">
									...
									<div class="row "
										...
										<div class="col-sm-12 text-center">
											<a
												href="${path}/info?ci_companyName=${item.ci_companyName}&ci_id=${item.ci_id}#locCr">리뷰
												코멘트</a>
										</div>
									</div>
								</div>
								<div class="col-lg-auto text-center">
									...
									<div class="row " style="">
										...
										<div class="col-sm-12 text-center">
											<a
												href="${path}/info?ci_companyName=${item.ci_companyName}&ci_id=${item.ci_id}#locIr">면접정보</a>
										</div>
									</div>
								</div>
							</div>
