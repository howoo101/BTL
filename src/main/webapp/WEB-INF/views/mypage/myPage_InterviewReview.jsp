                ...
                <c:forEach items="${myInterviewList }" var="list">
                    <tr>
                        <th scope="row"><a class='move'
                                           href="${path}/info?ci_companyName=${list.ci_companyName}&ci_id=${list.ci_id}">${list.ci_companyName}</a>
                        </th>
                        <td><c:out value="${list.ir_result}"/></td>
                        <td><c:out value="${list.ir_interviewDate}"/></td>
                            <%--                            <a href="#" aaa="123" onclick="alert($(this).attr('aaa'));return false;">t</a>--%>
                        <td>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label>
                            ...
                            <input class="user_id" type="hidden" value="<%=Integer.parseInt(user_id)%>">
...
<script>
    const modifyService = (function () {

        function interviewModify(interviewReview, callback, error) {
            $.ajax({
                type: 'put',
                url: '${path}/interviewReview/' + interviewReview.ir_id,
        ...
        function get(ir_id, callback, error) {
            ...
            $.get("${path}/interviewReview/" + ir_id + ".json", function (result) {
    ...
    $(document).ready(function () {
        ...
        $(".callmodify").on("click", function (e) {
            ...
            modifyService.get(ir_id, function (interviewReview) {
            ...
            $("#interviewModifyBtn").on("click", function (e) {
                ...
                if (!interviewReview.ir_interviewDate || !interviewReview.ir_difficulty || !interviewReview.ir_experience || !interviewReview.ir_route || !interviewReview.user_id || !interviewReview.ir_title || !interviewReview.ir_question || !interviewReview.ir_answer || !interviewReview.ir_result || !interviewReview.ir_resultDate) {
                    ...
                    modifyService.interviewModify(interviewReview, function (result) {
                        alert("성공적으로 변경되었습니다.");
                        modal.modal("hide");
                        location.reload()
                    });
