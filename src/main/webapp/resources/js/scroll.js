		        ...
		        let html = "<div class='card-body' data-startNo="+res.ci_id+">"
							...
							+								'<a href="'+path+'/info?ci_companyName='+res.ci_companyName+'&ci_id='+res.ci_id+'#locCr">'+'리뷰 코멘트</a>'
							+							'</div>'
							+						'</div>'
							+ 					'</div>'
							...
							+							'<div class="col-sm-12 text-center">'
							+								'<a href="'+path+'/info?ci_companyName='+res.ci_companyName+'&ci_id='+res.ci_id+'#locIr">'+'면접정보</a>'
							+							'</div>'
							+						'</div>'
							+					'</div>'
							+				'</div>'
